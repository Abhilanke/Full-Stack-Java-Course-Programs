...
//		pass = z;
		...
		////1st use of this => whenever you are using same name for instance and local variable..so to identify the difference between local and insatnce var we need to use this keyword
